      ...
      >
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 16, color: "var(--color-text-muted)" }}>
            Join TriAffect to unlock deep emotional insights.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 20, marginBottom: 28 }}>
          <div>
            <label style={{ display: "block", fontSize: 14, fontWeight: 600, color: "var(--color-text)", marginBottom: 8 }}>Full Name</label>
          ...
          <div>
            ...
            <p style={{ fontSize: 12, color: "var(--color-text-faint)", marginTop: 8 }}>Must be at least 6 characters.</p>
          </div>
